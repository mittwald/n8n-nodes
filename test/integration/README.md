...
- `IT_DNS_PARENT_ZONE_ID` (id of an existing DNS zone owned by the test account; used by the subordinate DNS-zone create/get/delete test — that test skips silently when unset)
